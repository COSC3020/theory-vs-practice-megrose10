...
2. Ellaborating more on the first point, while physical constraints with memory are present, we also have problems virtually. For example, if you are on a internet connection that is very slow or does not have a good connection, this can also affect your program runtime, and does not account in asymptotic complexity run time.
